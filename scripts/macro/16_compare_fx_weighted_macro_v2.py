...
INPUT_FILE = PROJECT_ROOT / "macro_data" / "processed" / "sovereign_weighted_scores_v2.csv"
OUTPUT_FILE = PROJECT_ROOT / "macro_data" / "processed" / "fx_weighted_macro_bias_v2.csv"

SCORE_COL = "weighted_sovereign_score_v2"
...
def main() -> None:
        ...
        results.append(
            {
                ...
                "quote_score_v2": quote_score,
                "score_diff": diff,
                "macro_bias_v2": classify_bias(diff),
            }
        )
    ...
    print(f"Saved FX weighted macro bias v2 to: {OUTPUT_FILE}")
    print()
    print(f"Weighted macro FX comparison v2 ({latest_year}):")
