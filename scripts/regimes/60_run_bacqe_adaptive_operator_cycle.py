"""
BACQE REGIME ENGINE - 60 Run BACQE Adaptive Operator Cycle

Runs the adaptive intelligence chain:

    54_build_bacqe_master_operator_dashboard.py
    56_build_strategy_performance_registry.py
    57_join_strategy_performance_to_current_market_state.py
    58_rank_adaptive_strategy_opportunities.py
    59_build_bacqe_adaptive_operator_console.py

This creates a repeatable one-command refresh cycle for the adaptive operator layer.
"""
...
SCRIPTS = [
    "scripts/regimes/54_build_bacqe_master_operator_dashboard.py",
    "scripts/regimes/56_build_strategy_performance_registry.py",
    "scripts/regimes/57_join_strategy_performance_to_current_market_state.py",
    "scripts/regimes/58_rank_adaptive_strategy_opportunities.py",
    "scripts/regimes/59_build_bacqe_adaptive_operator_console.py",
]

REPORT_DIR = DATA_LAKE_ROOT / "reports" / "bacqe_adaptive_operator_cycle"
