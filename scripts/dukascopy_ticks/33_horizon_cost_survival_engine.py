"""
BACQE DUKASCOPY 33 - HORIZON COST SURVIVAL ENGINE
"""
...
def build_output_root(symbol: str) -> Path:
    return (
        ...
        / "data"
        / "analysis"
        / "dukascopy_horizon_cost_survival"
        / f"symbol={symbol}"
    )
...
def run_horizon_cost_survival(
    ...
    banner("BACQE DUKASCOPY 33 - HORIZON COST SURVIVAL ENGINE")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run Dukascopy horizon cost survival."
    )
