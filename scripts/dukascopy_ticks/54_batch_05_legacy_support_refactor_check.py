"""
BACQE DUKASCOPY 54 - BATCH 05 LEGACY SUPPORT REFACTOR CHECK
"""
...
def main() -> None:
    banner("BACQE DUKASCOPY 54 - BATCH 05 LEGACY SUPPORT REFACTOR CHECK")
    ...
    output_csv = OUTPUT_ROOT / "check_tables" / "batch_05_legacy_support_check_latest.csv"
    report_path = OUTPUT_ROOT / "reports" / "batch_05_legacy_support_check_report_latest.txt"
    ...
    with open(report_path, "w", encoding="utf-8") as f:
        f.write("BACQE DUKASCOPY 54 - BATCH 05 LEGACY SUPPORT REFACTOR CHECK\n")
        f.write("=" * 80 + "\n\n")
    ...
    print("=" * 90)
    if fail_count == 0:
        print("[PASS] Batch 05 legacy support refactor scripts are safe.")
    else:
        print("[FAIL] Batch 05 legacy support refactor scripts still have issues to fix.")
